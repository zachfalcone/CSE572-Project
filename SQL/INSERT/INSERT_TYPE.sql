...
INSERT INTO TYPE VALUES (type_id.nextval, 'Maltese', 'The Maltese, Canis familiaris Maelitacus, is a small breed of dog in the Toy Group. It descends from dogs originating in the Central Mediterranean Area. The breed name and origins are generally understood to derive from the Mediterranean island nation of Malta.');
INSERT INTO TYPE VALUES (type_id.nextval, 'Shih Tzu', 'A Shih Tzu, also known as the Chrysanthemum Dog, is a toy dog breed, weighing from 4 to 7.25 kilograms when fully grown. The breed developed in China. The exact origin is unknown and is thought to have originated in the Tibetan Plateau.');
